...
Genre :<input type="text" name="Genre" placeholder="Genre">	<button type="text" name="submit">Submit</button><br><br>
<?php
if(isset($_POST["submit"]))
{
	if(!empty($_POST['Genre']))
	{
		...
		$query=mysqli_query($con,"SELECT * FROM book WHERE Subject='".$genre."'");
