...
if(isset($_POST['submit']))
{
  ...
  $select=mysqli_query($con,"SELECT email,password from facultydetails where email='".$email."'");
  if(mysqli_num_rows($select)==1)
  {
    ...
    $link="<a href='localhost/Latest%20library/faculty/reset.php?key=".$email1."&reset=".$pass."'>Click To Reset password</a>";
